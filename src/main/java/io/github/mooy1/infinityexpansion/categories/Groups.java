...
public final class Groups {
    ...
    public static final ItemGroup BYPLOT_EXPAND = new SubGroup("byplot_expand",
        new CustomItemStack(Material.END_CRYSTAL, "&e无尽&4科技拓展"),-100);
    public static final ItemGroup MAIN_CATEGORY = new MultiGroup("main",
            new CustomItemStack(Material.NETHER_STAR, "&b无尽&4科技&f-改版"), -100,
            MAIN_MATERIALS, BASIC_MACHINES, ADVANCED_MACHINES, STORAGE, MOB_SIMULATION, INFINITY_MATERIALS, INFINITY, BYPLOT_EXPAND);
    public static final ItemGroup INFINITY_CHEAT = new SubGroup("infinity_cheat",
            new CustomItemStack(Material.RESPAWN_ANCHOR, "&b无尽&7物品"),-100);
