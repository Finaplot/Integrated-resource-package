...
public final class Materials {
    ...
    public static final SlimefunItemStack Dragon_heart = new SlimefunItemStack(
        "DRAGON_HEART",
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new Singularity(GOLD_SINGULARITY, Material.GOLD_INGOT, 3000).register(plugin);
        new Singularity(IRON_SINGULARITY, Material.IRON_INGOT, 3000).register(plugin);
        new Singularity(DIAMOND_SINGULARITY, Material.DIAMOND, 3000).register(plugin);
        new Singularity(EMERALD_SINGULARITY, Material.EMERALD, 3000).register(plugin);
        new Singularity(NETHERITE_SINGULARITY, Material.NETHERITE_INGOT, 3000).register(plugin);
        ...
        new Singularity(INFINITY_SINGULARITY, INFINITE_INGOT, 600).register(plugin);
        new Singularity(VOID_SINGULARITY,VOID_INGOT,600).register(plugin);
        new Singularity(Dragon_heart,Material.DRAGON_EGG,64).register(plugin);
    }
