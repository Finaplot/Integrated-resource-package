...
public final class MobData {
    ...
    private static final int CHAMBER_ENERGY = 500;
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        }).addDrop(SlimefunItems.COMPRESSED_CARBON, 8, 2).addDrop(Materials.INFINITE_INGOT, 8, 3).register(plugin);
        ...
        }).addDrop(Materials.VOID_BIT, 1).addDrop(Materials.ENDER_ESSENCE, 4).addDrop(Material.DRAGON_EGG, 5_00).
            addDrop(Materials.Dragon_heart, 1_000).register(plugin);
