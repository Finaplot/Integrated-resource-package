...
public final class Machines {
    ...
    public static final SlimefunItemStack BASIC_DESTRUCTOR = new SlimefunItemStack(
        "DRAGON_HEART_DESTRUCTOR",
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        RandomizedItemStack Test = new RandomizedItemStack(
            new SlimefunItemStack(Materials.COPPER_SINGULARITY, 4),
            new SlimefunItemStack(Materials.ZINC_SINGULARITY, 4),
            new SlimefunItemStack(Materials.TIN_SINGULARITY, 4),
            new SlimefunItemStack(Materials.ALUMINUM_SINGULARITY, 4),
            new SlimefunItemStack(Materials.MAGNESIUM_SINGULARITY, 4),
            new SlimefunItemStack(Materials.LEAD_SINGULARITY, 4),
            new SlimefunItemStack(Materials.GOLD_SINGULARITY, 4),
            new SlimefunItemStack(Materials.IRON_SINGULARITY, 4),
            new SlimefunItemStack(Materials.EMERALD_SINGULARITY, 4),
            new SlimefunItemStack(Materials.NETHERITE_SINGULARITY, 4),
            new SlimefunItemStack(Materials.COAL_SINGULARITY, 4),
            new SlimefunItemStack(Materials.REDSTONE_SINGULARITY, 4),
            new SlimefunItemStack(Materials.LAPIS_SINGULARITY, 4),
            new SlimefunItemStack(Materials.QUARTZ_SINGULARITY, 4),
            new SlimefunItemStack(Materials.VOID_SINGULARITY, 1)
        );
        new MachineBlock(Groups.BYPLOT_EXPAND, BASIC_DESTRUCTOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
            new SlimefunItemStack(Materials.VOID_SINGULARITY, 1), new SlimefunItemStack(Materials.VOID_SINGULARITY, 1),
            new SlimefunItemStack(Materials.VOID_SINGULARITY, 1), new SlimefunItemStack(Materials.VOID_SINGULARITY, 1),
            new SlimefunItemStack(Materials.Dragon_heart, 16), new SlimefunItemStack(Materials.VOID_SINGULARITY, 1),
            new SlimefunItemStack(Materials.VOID_SINGULARITY, 1), new SlimefunItemStack(Materials.VOID_SINGULARITY, 1),
            new SlimefunItemStack(Materials.VOID_SINGULARITY, 1)
        }).addRecipe(Test, new Machines.RandomizedItemStack(Materials.Dragon_heart))
            .ticksPerOutput(10).energyPerTick(5000).register(plugin);
    }
